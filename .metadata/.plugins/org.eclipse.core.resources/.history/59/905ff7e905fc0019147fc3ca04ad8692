...
public class C1Centros {
	...
	public void actualizarCentros(Integer cod, String nombre, String direccion, String localidad, String provincia) {
		ObjectContainer bd=Db4oEmbedded.openFile(Db4oEmbedded.newConfiguration(),"basedatos.db4o");
	...
	public void VerProfesores(int id) {
		ObjectContainer bd=Db4oEmbedded.openFile(Db4oEmbedded.newConfiguration(),"basedatos4.db4o");
        C1Centros c = new C1Centros(id,null,null,null,null,null);
        ObjectSet res = bd.queryByExample(c);
